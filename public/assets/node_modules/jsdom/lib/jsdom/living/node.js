...
const cloningSteps = require("jsdom/lib/jsdom/living/helpers/internal-constants").cloningSteps;
...
const orderedSetParser = require("jsdom/lib/jsdom/living/helpers/ordered-set-parser");
const createHTMLCollection = require("jsdom/lib/jsdom/living/html-collection").create;
const domTokenListContains = require("jsdom/lib/jsdom/living/dom-token-list").contains;
