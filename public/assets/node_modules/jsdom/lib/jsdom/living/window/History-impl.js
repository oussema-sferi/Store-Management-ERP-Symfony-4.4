"use strict";
const DOMException = require("jsdom/lib/jsdom/web-idl/DOMException.js");
const documentBaseURL = require("jsdom/lib/jsdom/living/helpers/document-base-url.js").documentBaseURL;
const resolveURLToResultingParsedURL = require("jsdom/lib/jsdom/living/helpers/document-base-url.js").resolveURLToResultingParsedURL;
const traverseHistory = require("jsdom/lib/jsdom/living/window/navigation.js").traverseHistory;
