...
const applyDocumentFeatures = require("jsdom/lib/jsdom/browser/documentfeatures").applyDocumentFeatures;
...
const getAttributeValue = require("jsdom/lib/jsdom/living/attributes").getAttributeValue;
