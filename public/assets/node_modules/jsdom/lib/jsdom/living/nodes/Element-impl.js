...
const memoizeQuery = require("jsdom/lib/jsdom/utils").memoizeQuery;
const mapper = require("jsdom/lib/jsdom/utils").mapper;
const clone = require("jsdom/lib/jsdom/living/node").clone;
const domSymbolTree = require("jsdom/lib/jsdom/living/helpers/internal-constants").domSymbolTree;
const resetDOMTokenList = require("jsdom/lib/jsdom/living/dom-token-list").reset;
const createLiveNodeList = require("jsdom/lib/jsdom/living/node-list").createLive;
const DOMException = require("jsdom/lib/jsdom/web-idl/DOMException");
const createDOMTokenList = require("jsdom/lib/jsdom/living/dom-token-list").create;
const attrGenerated = require("jsdom/lib/jsdom/living/generated/Attr");
const MutationEvent = require("jsdom/lib/jsdom/living/generated/MutationEvent").interface;
const validateNames = require("jsdom/lib/jsdom/living/helpers/validate-names");
const listOfElementsWithClassNames = require("jsdom/lib/jsdom/living/node").listOfElementsWithClassNames;
