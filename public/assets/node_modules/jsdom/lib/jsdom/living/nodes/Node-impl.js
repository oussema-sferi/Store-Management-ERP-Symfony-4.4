...
const simultaneousIterators = require("jsdom/lib/jsdom/utils").simultaneousIterators;
...
const updateNodeList = require("jsdom/lib/jsdom/living/node-list").update;
...
const cloneNode = require("jsdom/lib/jsdom/living/node").clone;
