"use strict";
const internalQuerySelector = require("jsdom/lib/jsdom/living/helpers/selectors").querySelector;
const internalGetAttr = require("jsdom/lib/jsdom/living/attributes").getAttributeValue;
