...
exports.serializeBase64 = exports.TrieBuilder = exports.BITS_32 = exports.BITS_16 = undefined;

var _createClass = function () { function defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if ("value" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } } return function (Constructor, protoProps, staticProps) { if (protoProps) defineProperties(Constructor.prototype, protoProps); if (staticProps) defineProperties(Constructor, staticProps); return Constructor; }; }();

var _Trie = require('css-line-break/dist/Trie');
 ...
 */
var UTRIE2_OPTIONS_VALUE_BITS_MASK = 0x000f;

/** Number of code points per index-1 table entry. 2048=0x800 */
var UTRIE2_CP_PER_INDEX_1_ENTRY = 1 << _Trie.UTRIE2_SHIFT_1;

/** The alignment size of a data block. Also the granularity for compaction. */
var UTRIE2_DATA_GRANULARITY = 1 << _Trie.UTRIE2_INDEX_SHIFT;
...
var UTRIE2_MAX_INDEX_1_LENGTH = 0x100000 >> _Trie.UTRIE2_SHIFT_1;
/*
 ...
 */
var UNEWTRIE2_INDEX_GAP_OFFSET = _Trie.UTRIE2_INDEX_2_BMP_LENGTH;
var UNEWTRIE2_INDEX_GAP_LENGTH = _Trie.UTRIE2_UTF8_2B_INDEX_2_LENGTH + UTRIE2_MAX_INDEX_1_LENGTH + _Trie.UTRIE2_INDEX_2_MASK & ~_Trie.UTRIE2_INDEX_2_MASK;
/**
 ...
 */
var UNEWTRIE2_MAX_INDEX_2_LENGTH = (0x110000 >> _Trie.UTRIE2_SHIFT_2) + _Trie.UTRIE2_LSCP_INDEX_2_LENGTH + UNEWTRIE2_INDEX_GAP_LENGTH + _Trie.UTRIE2_INDEX_2_BLOCK_LENGTH;
var UNEWTRIE2_INDEX_1_LENGTH = 0x110000 >> _Trie.UTRIE2_SHIFT_1;
/**
...
var UNEWTRIE2_INDEX_2_START_OFFSET = UNEWTRIE2_INDEX_2_NULL_OFFSET + _Trie.UTRIE2_INDEX_2_BLOCK_LENGTH;
/**
 * The null data block.
 ...
 */
var UTRIE2_MAX_DATA_LENGTH = 0xffff << _Trie.UTRIE2_INDEX_SHIFT;

var BITS_16 = exports.BITS_16 = 16;
var BITS_32 = exports.BITS_32 = 32;

var isHighSurrogate = function isHighSurrogate(c) {
    return c >= 0xd800 && c <= 0xdbff;
};

var equal_int = function equal_int(a, s, t, length) {
...
var TrieBuilder = exports.TrieBuilder = function () {
    function TrieBuilder() {
        var initialValue = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : 0;
        var errorValue = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 0;

        _classCallCheck(this, TrieBuilder);
         ...
         */
        this.map = new Uint32Array(UNEWTRIE2_MAX_DATA_LENGTH >> _Trie.UTRIE2_SHIFT_2);
        /*
        ...
        for (i = 0, j = 0; j < 0x80; ++i, j += _Trie.UTRIE2_DATA_BLOCK_LENGTH) {
            this.index2[i] = j;
            this.map[i] = 1;
        }

        /* reference counts for the bad-UTF-8-data block */
        for (; j < 0xc0; ++i, j += _Trie.UTRIE2_DATA_BLOCK_LENGTH) {
            this.map[i] = 0;
        }
        ...
        this.map[i++] = (0x110000 >> _Trie.UTRIE2_SHIFT_2) - (0x80 >> _Trie.UTRIE2_SHIFT_2) + 1 + _Trie.UTRIE2_LSCP_INDEX_2_LENGTH;
        j += _Trie.UTRIE2_DATA_BLOCK_LENGTH;
        for (; j < UNEWTRIE2_DATA_START_OFFSET; ++i, j += _Trie.UTRIE2_DATA_BLOCK_LENGTH) {
            this.map[i] = 0;
        }
        /*
         ...
         */
        for (i = 0x80 >> _Trie.UTRIE2_SHIFT_2; i < _Trie.UTRIE2_INDEX_2_BMP_LENGTH; ++i) {
        ...
        for (i = 0; i < _Trie.UTRIE2_INDEX_2_BLOCK_LENGTH; ++i) {
        ...
        for (i = 0, j = 0; i < _Trie.UTRIE2_OMITTED_BMP_INDEX_1_LENGTH; ++i, j += _Trie.UTRIE2_INDEX_2_BLOCK_LENGTH) {
            this.index1[i] = j;
        }
         ...
         */
        for (i = 0x80; i < 0x800; i += _Trie.UTRIE2_DATA_BLOCK_LENGTH) {
    ...
    _createClass(TrieBuilder, [{
        key: 'set',
        value: function set(c, value) {
            if (c < 0 || c > 0x10ffff) {
        ...
        key: 'setRange',
        value: function setRange(start, end, value, overwrite) {
            /*
            ...
            */
            ...
            var limit = end + 1;
            if ((start & _Trie.UTRIE2_DATA_MASK) !== 0) {
                /* set partial block at [start..following block boundary[ */
                block = this.getDataBlock(start, true);
                var nextStart = start + _Trie.UTRIE2_DATA_BLOCK_LENGTH & ~_Trie.UTRIE2_DATA_MASK;
                if (nextStart <= limit) {
                    this.fillBlock(block, start & _Trie.UTRIE2_DATA_MASK, _Trie.UTRIE2_DATA_BLOCK_LENGTH, value, this.initialValue, overwrite);
                    start = nextStart;
                } else {
                    this.fillBlock(block, start & _Trie.UTRIE2_DATA_MASK, limit & _Trie.UTRIE2_DATA_MASK, value, this.initialValue, overwrite);
                    return this;
                }
            }
            /* number of positions in the last, partial block */
            rest = limit & _Trie.UTRIE2_DATA_MASK;
            /* round down limit to a block boundary */
            limit &= ~_Trie.UTRIE2_DATA_MASK;
            ...
            while (start < limit) {
                ...
                if (value === this.initialValue && this.isInNullBlock(start, true)) {
                    start += _Trie.UTRIE2_DATA_BLOCK_LENGTH; /* nothing to do */
                    continue;
                }
                /* get index value */
                i2 = this.getIndex2Block(start, true);
                i2 += start >> _Trie.UTRIE2_SHIFT_2 & _Trie.UTRIE2_INDEX_2_MASK;
                ...
                if (this.isWritableBlock(block)) {
                    ...
                    if (overwrite && block >= UNEWTRIE2_DATA_0800_OFFSET) {
                        ...
                        */
                        ...
                        this.fillBlock(block, 0, _Trie.UTRIE2_DATA_BLOCK_LENGTH, value, this.initialValue, overwrite);
                    }
                ...
                start += _Trie.UTRIE2_DATA_BLOCK_LENGTH;
            }
            if (rest > 0) {
        ...
        key: '_get',
        value: function _get(c, fromLSCP) {
            var i2 = void 0;
            ...
            if (c >= 0xd800 && c < 0xdc00 && fromLSCP) {
                i2 = _Trie.UTRIE2_LSCP_INDEX_2_OFFSET - (0xd800 >> _Trie.UTRIE2_SHIFT_2) + (c >> _Trie.UTRIE2_SHIFT_2);
            } else {
                i2 = this.index1[c >> _Trie.UTRIE2_SHIFT_1] + (c >> _Trie.UTRIE2_SHIFT_2 & _Trie.UTRIE2_INDEX_2_MASK);
            }
            var block = this.index2[i2];
            return this.data[block + (c & _Trie.UTRIE2_DATA_MASK)];
        }
    }, {
        key: 'freeze',
        value: function freeze() {
            var valueBits = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : BITS_32;

            var i = void 0;
            var allIndexesLength = void 0;
            var dataMove = void 0; /* >0 if the data is moved to the end of the index array */
            /* compact if necessary */
            if (!this.isCompacted) {
                this.compactTrie();
            }
            if (this.highStart <= 0x10000) {
                allIndexesLength = _Trie.UTRIE2_INDEX_1_OFFSET;
            } else {
            ...
            var destIdx = 0;
            for (i = 0; i < _Trie.UTRIE2_INDEX_2_BMP_LENGTH; i++) {
                index[destIdx++] = this.index2[i] + dataMove >> _Trie.UTRIE2_INDEX_SHIFT;
            }
            ...
            for (; i < 0xe0 - 0xc0; ++i) {
                /* C2..DF */
                index[destIdx++] = dataMove + this.index2[i << 6 - _Trie.UTRIE2_SHIFT_2];
            }

            if (this.highStart > 0x10000) {
                var index1Length = this.highStart - 0x10000 >> _Trie.UTRIE2_SHIFT_1;
                var index2Offset = _Trie.UTRIE2_INDEX_2_BMP_LENGTH + _Trie.UTRIE2_UTF8_2B_INDEX_2_LENGTH + index1Length;
                ...
                for (i = 0; i < index1Length; i++) {
                    ...
                    index[destIdx++] = UTRIE2_INDEX_2_OFFSET + this.index1[i + _Trie.UTRIE2_OMITTED_BMP_INDEX_1_LENGTH];
                }
                ...
                */
                for (i = 0; i < this.index2Length - index2Offset; i++) {
                    index[destIdx++] = dataMove + this.index2[index2Offset + i] >> _Trie.UTRIE2_INDEX_SHIFT;
                }
            }
            ...
            switch (valueBits) {
                case BITS_16:
                    ...
                    return new _Trie.Trie(this.initialValue, this.errorValue, this.highStart, dataMove + this.dataLength - UTRIE2_DATA_GRANULARITY, index, data16);
                case BITS_32:
                    ...
                    return new _Trie.Trie(this.initialValue, this.errorValue, this.highStart, dataMove + this.dataLength - UTRIE2_DATA_GRANULARITY, index, data32);
                default:
        ...
        key: 'findHighStart',
        value: function findHighStart(highValue) {
            var value = void 0;
            var i2 = void 0,
                j = void 0,
                i2Block = void 0,
            ...
            while (c > 0) {
                ...
                if (i2Block === this.index2NullOffset) {
                    ...
                    for (i2 = _Trie.UTRIE2_INDEX_2_BLOCK_LENGTH; i2 > 0;) {
                        block = this.index2[i2Block + --i2];
                        if (block === prevBlock) {
                            /* the block is the same as the previous one, and filled with highValue */
                            c -= _Trie.UTRIE2_DATA_BLOCK_LENGTH;
                            continue;
                        }
                        prevBlock = block;
                        if (block === this.dataNullOffset) {
                            ...
                            for (j = _Trie.UTRIE2_DATA_BLOCK_LENGTH; j > 0;) {
        ...
        value: function compactData() {
            ...
            for (start = 0, i = 0; start < newStart; start += _Trie.UTRIE2_DATA_BLOCK_LENGTH, ++i) {
                this.map[i] = start;
            }
            /*
            ...
            */
            blockLength = 64;
            blockCount = blockLength >> _Trie.UTRIE2_SHIFT_2;
            for (start = newStart; start < this.dataLength;) {
                ...
                */
                if (start === UNEWTRIE2_DATA_0800_OFFSET) {
                    blockLength = _Trie.UTRIE2_DATA_BLOCK_LENGTH;
                    blockCount = 1;
                }
                /* skip blocks that are not used */
                if (this.map[start >> _Trie.UTRIE2_SHIFT_2] <= 0) {
                ...
                if (movedStart >= 0) {
                    ...
                    for (i = blockCount, mapIndex = start >> _Trie.UTRIE2_SHIFT_2; i > 0; --i) {
                        this.map[mapIndex++] = movedStart;
                        movedStart += _Trie.UTRIE2_DATA_BLOCK_LENGTH;
                    }
                    /* advance start to the next block */
                    start += blockLength;
                    /* leave newStart with the previous block! */
                ...
                for (overlap = blockLength - UTRIE2_DATA_GRANULARITY; overlap > 0 && !equal_int(this.data, newStart - overlap, start, overlap); overlap -= UTRIE2_DATA_GRANULARITY) {}
                if (overlap > 0 || newStart < start) {
                    ...
                    /* no overlap && newStart==start */for (i = blockCount, mapIndex = start >> _Trie.UTRIE2_SHIFT_2; i > 0; --i) {
            ...
            for (i = 0; i < this.index2Length; ++i) {
                ...
                this.index2[i] = this.map[this.index2[i] >> _Trie.UTRIE2_SHIFT_2];
            }
            this.dataNullOffset = this.map[this.dataNullOffset >> _Trie.UTRIE2_SHIFT_2];
        ...
        key: 'findSameDataBlock',
        value: function findSameDataBlock(dataLength, otherBlock, blockLength) {
            var block = 0;
        ...
        key: 'compactIndex2',
        value: function compactIndex2() {
            var i = void 0,
                start = void 0,
                movedStart = void 0,
                overlap = void 0;
            /* do not compact linear-BMP index-2 blocks */
            var newStart = _Trie.UTRIE2_INDEX_2_BMP_LENGTH;
            for (start = 0, i = 0; start < newStart; start += _Trie.UTRIE2_INDEX_2_BLOCK_LENGTH, ++i) {
                this.map[i] = start;
            }
            /* Reduce the index table gap to what will be needed at runtime. */
            newStart += _Trie.UTRIE2_UTF8_2B_INDEX_2_LENGTH + (this.highStart - 0x10000 >> _Trie.UTRIE2_SHIFT_1);
            for (start = UNEWTRIE2_INDEX_2_NULL_OFFSET; start < this.index2Length;) {
                ...
                if ((movedStart = this.findSameIndex2Block(newStart, start)) >= 0) {
                    /* found an identical block, set the other block's index value for the current block */
                    this.map[start >> _Trie.UTRIE2_SHIFT_1_2] = movedStart;
                    /* advance start to the next block */
                    start += _Trie.UTRIE2_INDEX_2_BLOCK_LENGTH;
                    /* leave newStart with the previous block! */
                    continue;
                }
                /* see if the beginning of this block can be overlapped with the end of the previous block */
                /* look for maximum overlap with the previous, adjacent block */
                for (overlap = _Trie.UTRIE2_INDEX_2_BLOCK_LENGTH - 1; overlap > 0 && !equal_int(this.index2, newStart - overlap, start, overlap); --overlap) {}
                if (overlap > 0 || newStart < start) {
                    /* some overlap, or just move the whole block */
                    this.map[start >> _Trie.UTRIE2_SHIFT_1_2] = newStart - overlap;
                    /* move the non-overlapping indexes to their new positions */
                    start += overlap;
                    for (i = _Trie.UTRIE2_INDEX_2_BLOCK_LENGTH - overlap; i > 0; --i) {
                        this.index2[newStart++] = this.index2[start++];
                    }
                } else {
                    /* no overlap && newStart==start */this.map[start >> _Trie.UTRIE2_SHIFT_1_2] = start;
                    start += _Trie.UTRIE2_INDEX_2_BLOCK_LENGTH;
                    newStart = start;
                }
            }
            ...
            for (i = 0; i < UNEWTRIE2_INDEX_1_LENGTH; ++i) {
                this.index1[i] = this.map[this.index1[i] >> _Trie.UTRIE2_SHIFT_1_2];
            }
            this.index2NullOffset = this.map[this.index2NullOffset >> _Trie.UTRIE2_SHIFT_1_2];
            /*
            ...
            while ((newStart & (UTRIE2_DATA_GRANULARITY - 1 | 1)) !== 0) {
                ...
                this.index2[newStart++] = 0x0000ffff << _Trie.UTRIE2_INDEX_SHIFT;
            }

            this.index2Length = newStart;
        }
    }, {
        key: 'findSameIndex2Block',
        value: function findSameIndex2Block(index2Length, otherBlock) {
            /* ensure that we do not even partially get past index2Length */
            index2Length -= _Trie.UTRIE2_INDEX_2_BLOCK_LENGTH;
            for (var block = 0; block <= index2Length; ++block) {
                if (equal_int(this.index2, block, otherBlock, _Trie.UTRIE2_INDEX_2_BLOCK_LENGTH)) {
                    return block;
                }
            }
            return -1;
        ...
        key: '_set',
        value: function _set(c, forLSCP, value) {
            if (this.isCompacted) {
                throw new Error('Trie was already compacted');
            }
            var block = this.getDataBlock(c, forLSCP);
            this.data[block + (c & _Trie.UTRIE2_DATA_MASK)] = value;
            return this;
        }
    }, {
        key: 'writeBlock',
        value: function writeBlock(block, value) {
            var limit = block + _Trie.UTRIE2_DATA_BLOCK_LENGTH;
            while (block < limit) {
        ...
        key: 'isInNullBlock',
        value: function isInNullBlock(c, forLSCP) {
            var i2 = isHighSurrogate(c) && forLSCP ? _Trie.UTRIE2_LSCP_INDEX_2_OFFSET - (0xd800 >> _Trie.UTRIE2_SHIFT_2) + (c >> _Trie.UTRIE2_SHIFT_2) : this.index1[c >> _Trie.UTRIE2_SHIFT_1] + (c >> _Trie.UTRIE2_SHIFT_2 & _Trie.UTRIE2_INDEX_2_MASK);
            var block = this.index2[i2];
            return block === this.dataNullOffset;
        }
    }, {
        key: 'fillBlock',
        value: function fillBlock(block, start, limit, value, initialValue, overwrite) {
            var pLimit = block + limit;
            if (overwrite) {
                for (var _i = block + start; _i < pLimit; _i++) {
                    this.data[_i] = value;
                }
            } else {
                for (var _i2 = block + start; _i2 < pLimit; _i2++) {
                    if (this.data[_i2] === initialValue) {
                        this.data[_i2] = value;
                    }
                }
            }
        ...
        key: 'setIndex2Entry',
        value: function setIndex2Entry(i2, block) {
            ++this.map[block >> _Trie.UTRIE2_SHIFT_2]; /* increment first, in case block==oldBlock! */
            var oldBlock = this.index2[i2];
            if (0 === --this.map[oldBlock >> _Trie.UTRIE2_SHIFT_2]) {
                this.releaseDataBlock(oldBlock);
            }
            this.index2[i2] = block;
        }
    }, {
        key: 'releaseDataBlock',
        value: function releaseDataBlock(block) {
            /* put this block at the front of the free-block chain */
            this.map[block >> _Trie.UTRIE2_SHIFT_2] = -this.firstFreeBlock;
            this.firstFreeBlock = block;
        }
    }, {
        key: 'getDataBlock',
        value: function getDataBlock(c, forLSCP) {
            var i2 = this.getIndex2Block(c, forLSCP);

            i2 += c >> _Trie.UTRIE2_SHIFT_2 & _Trie.UTRIE2_INDEX_2_MASK;
            var oldBlock = this.index2[i2];
        ...
        key: 'isWritableBlock',
        value: function isWritableBlock(block) {
            return block !== this.dataNullOffset && 1 === this.map[block >> _Trie.UTRIE2_SHIFT_2];
        }
    }, {
        key: 'getIndex2Block',
        value: function getIndex2Block(c, forLSCP) {
            if (c >= 0xd800 && c < 0xdc00 && forLSCP) {
                return _Trie.UTRIE2_LSCP_INDEX_2_OFFSET;
            }
            var i1 = c >> _Trie.UTRIE2_SHIFT_1;
        ...
        key: 'allocDataBlock',
        value: function allocDataBlock(copyBlock) {
            var newBlock = void 0;

            if (this.firstFreeBlock !== 0) {
                /* get the first free block */
                newBlock = this.firstFreeBlock;
                this.firstFreeBlock = -this.map[newBlock >> _Trie.UTRIE2_SHIFT_2];
            } else {
                /* get a new block from the high end */
                newBlock = this.dataLength;
                var newTop = newBlock + _Trie.UTRIE2_DATA_BLOCK_LENGTH;
            ...
            this.data.set(this.data.subarray(copyBlock, copyBlock + _Trie.UTRIE2_DATA_BLOCK_LENGTH), newBlock);
            this.map[newBlock >> _Trie.UTRIE2_SHIFT_2] = 0;
            return newBlock;
        }
    }, {
        key: 'allocIndex2Block',
        value: function allocIndex2Block() {
            var newBlock = this.index2Length;
            var newTop = newBlock + _Trie.UTRIE2_INDEX_2_BLOCK_LENGTH;
            ...
            this.index2.set(this.index2.subarray(this.index2NullOffset, this.index2NullOffset + _Trie.UTRIE2_INDEX_2_BLOCK_LENGTH), newBlock);
            return newBlock;
        }
    }]);
...
var serializeBase64 = exports.serializeBase64 = function serializeBase64(trie) {
    ...
    return (0, _base64Arraybuffer.encode)(buffer);
};