    ...
    function the_pager() {
        ...
        function create_pager() {
            var pagerhtml = 
                ...
                '<button type="button" class="tablepager-first btn btn-primary"></button>'+
                '<button type="button" class="tablepager-prev btn btn-primary"></button>'+
                '<input type="text" class="tablepager-display form-control" readonly>'+
                '&nbsp;<button type="button" class="tablepager-next btn btn-primary"></button>'+
                '<button type="button" class="tablepager-last btn btn-primary"></button>'+
                '<select class="tablepager-pagesize form-control">'+
